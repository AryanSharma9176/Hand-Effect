...
def draw_hand_landmarks(frame, landmarks):
    ...
    for x, y in points:
        cv2.circle(frame, (x, y), 3, (255, 80, 180), -1, cv2.LINE_AA)
...
def main():
    ...
    landmarker = hand_landmarker.HandLandmarker.create_from_model_path(str(model_path))
    ...
    while True:
        ...
        if corners is not None:
            ...
            if x1 - x0 > 20 and y1 - y0 > 20:
                ...
                processed = apply_effect(EFFECTS[effect_idx][1], patch)
